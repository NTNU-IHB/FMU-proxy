...
ScalarVariable = function(args) {
  ...
  if (args) {
    ...
    if (args.declaredType !== undefined && args.declaredType !== null) {
      this.declaredType = args.declaredType;
    }
...
ScalarVariable.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.valueReference = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.declaredType = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ScalarVariable.prototype.write = function(output) {
  ...
  if (this.valueReference !== null && this.valueReference !== undefined) {
    output.writeFieldBegin('valueReference', Thrift.Type.I32, 1);
    output.writeI32(this.valueReference);
    output.writeFieldEnd();
  }
  ...
  if (this.declaredType !== null && this.declaredType !== undefined) {
    output.writeFieldBegin('declaredType', Thrift.Type.STRING, 4);
    output.writeString(this.declaredType);
    output.writeFieldEnd();
  }
  if (this.initial !== null && this.initial !== undefined) {
    output.writeFieldBegin('initial', Thrift.Type.I32, 5);
    output.writeI32(this.initial);
    output.writeFieldEnd();
  }
  if (this.causality !== null && this.causality !== undefined) {
    output.writeFieldBegin('causality', Thrift.Type.I32, 6);
    output.writeI32(this.causality);
    output.writeFieldEnd();
  }
  if (this.variability !== null && this.variability !== undefined) {
    output.writeFieldBegin('variability', Thrift.Type.I32, 7);
    output.writeI32(this.variability);
    output.writeFieldEnd();
  }
  if (this.attribute !== null && this.attribute !== undefined) {
    output.writeFieldBegin('attribute', Thrift.Type.STRUCT, 8);
...
Unknown.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.dependenciesKind = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Unknown.prototype.write = function(output) {
  ...
  if (this.dependenciesKind !== null && this.dependenciesKind !== undefined) {
    output.writeFieldBegin('dependenciesKind', Thrift.Type.I32, 3);
    output.writeI32(this.dependenciesKind);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
ModelDescription = function(args) {
  ...
  this.supportsCoSimulation = null;
  this.supportsModelExchange = null;
  if (args) {
    ...
    if (args.supportsCoSimulation !== undefined && args.supportsCoSimulation !== null) {
      this.supportsCoSimulation = args.supportsCoSimulation;
    }
    if (args.supportsModelExchange !== undefined && args.supportsModelExchange !== null) {
      this.supportsModelExchange = args.supportsModelExchange;
    }
  }
};
...
ModelDescription.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 12:
      if (ftype == Thrift.Type.I32) {
        this.variableNamingConvention = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      case 15:
      if (ftype == Thrift.Type.BOOL) {
        this.supportsCoSimulation = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 16:
      if (ftype == Thrift.Type.BOOL) {
        this.supportsModelExchange = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ModelDescription.prototype.write = function(output) {
  ...
  if (this.variableNamingConvention !== null && this.variableNamingConvention !== undefined) {
    output.writeFieldBegin('variableNamingConvention', Thrift.Type.I32, 12);
    output.writeI32(this.variableNamingConvention);
    output.writeFieldEnd();
  }
  ...
  if (this.supportsCoSimulation !== null && this.supportsCoSimulation !== undefined) {
    output.writeFieldBegin('supportsCoSimulation', Thrift.Type.BOOL, 15);
    output.writeBool(this.supportsCoSimulation);
    output.writeFieldEnd();
  }
  if (this.supportsModelExchange !== null && this.supportsModelExchange !== undefined) {
    output.writeFieldBegin('supportsModelExchange', Thrift.Type.BOOL, 16);
    output.writeBool(this.supportsModelExchange);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
