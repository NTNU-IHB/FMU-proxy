...
_GENERICFMUSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ReadInt',
    full_name='no.mechatronics.sfi.grpc_fmu.GenericFmuService.ReadInt',
    index=9,
    containing_service=None,
  ...
  _descriptor.MethodDescriptor(
    name='WriteInt',
    full_name='no.mechatronics.sfi.grpc_fmu.GenericFmuService.WriteInt',
    index=13,
    containing_service=None,
