...
FmuService_getCurrentTime_args::~FmuService_getCurrentTime_args() throw() {
}


uint32_t FmuService_getCurrentTime_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t FmuService_getCurrentTime_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FmuService_getCurrentTime_args");
...
FmuService_getCurrentTime_pargs::~FmuService_getCurrentTime_pargs() throw() {
}


uint32_t FmuService_getCurrentTime_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("FmuService_getCurrentTime_pargs");
...
FmuService_getCurrentTime_result::~FmuService_getCurrentTime_result() throw() {
}


uint32_t FmuService_getCurrentTime_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t FmuService_getCurrentTime_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("FmuService_getCurrentTime_result");
...
FmuService_getCurrentTime_presult::~FmuService_getCurrentTime_presult() throw() {
}


uint32_t FmuService_getCurrentTime_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
double FmuServiceClient::getCurrentTime(const FmuId fmu_id)
{
  send_getCurrentTime(fmu_id);
  return recv_getCurrentTime();
}

void FmuServiceClient::send_getCurrentTime(const FmuId fmu_id)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("getCurrentTime", ::apache::thrift::protocol::T_CALL, cseqid);

  FmuService_getCurrentTime_pargs args;
  args.fmu_id = &fmu_id;
  args.write(oprot_);
...
double FmuServiceClient::recv_getCurrentTime()
{
  ...
  double _return;
  FmuService_getCurrentTime_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
...
void FmuServiceProcessor::process_getCurrentTime(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("FmuService.getCurrentTime", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "FmuService.getCurrentTime");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "FmuService.getCurrentTime");
  }

  FmuService_getCurrentTime_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "FmuService.getCurrentTime", bytes);
  }

  FmuService_getCurrentTime_result result;
  try {
    result.success = iface_->getCurrentTime(args.fmu_id);
    result.__isset.success = true;
  } catch ( ::fmuproxy::thrift::NoSuchFmuException &ex) {
    result.ex = ex;
    result.__isset.ex = true;
    ...
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "FmuService.getCurrentTime");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "FmuService.getCurrentTime");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "FmuService.getCurrentTime", bytes);
  }
}
...
double FmuServiceConcurrentClient::getCurrentTime(const FmuId fmu_id)
{
  int32_t seqid = send_getCurrentTime(fmu_id);
  return recv_getCurrentTime(seqid);
}

int32_t FmuServiceConcurrentClient::send_getCurrentTime(const FmuId fmu_id)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getCurrentTime", ::apache::thrift::protocol::T_CALL, cseqid);
...
double FmuServiceConcurrentClient::recv_getCurrentTime(const int32_t seqid)
{
