...
class Iface(object):
    ...
    def getSimulationTime(self, fmu_id):
        """
        Parameters:
         - fmu_id
...
class Client(Iface):
    ...
    def getSimulationTime(self, fmu_id):
        ...
        """
        self.send_getSimulationTime(fmu_id)
        return self.recv_getSimulationTime()

    def send_getSimulationTime(self, fmu_id):
...
class Processor(Iface, TProcessor):
    ...
    def process_getSimulationTime(self, seqid, iprot, oprot):
        ...
        result = getSimulationTime_result()
        try:
            result.success = self._handler.getSimulationTime(args.fmu_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except definitions.ttypes.NoSuchFmuException as ex:
