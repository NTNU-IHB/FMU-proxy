            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<java.lang.Double>(_list8.size);
                double _elem9;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RealRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.value != null) {
        oprot.writeFieldBegin(VALUE_FIELD_DESC);
        {
          ...
          for (double _iter11 : struct.value)
          {
      ...
      if (struct.isSetValue()) {
        {
          ...
          for (double _iter12 : struct.value)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.value = new java.util.ArrayList<java.lang.Double>(_list13.size);
          double _elem14;
