            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.model_variables = new java.util.ArrayList<ScalarVariable>(_list104.size);
                @org.apache.thrift.annotation.Nullable ScalarVariable _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = new ScalarVariable();
                  _elem105.read(iprot);
                  struct.model_variables.add(_elem105);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelDescription struct) throws org.apache.thrift.TException {
      ...
      if (struct.model_variables != null) {
        oprot.writeFieldBegin(MODEL_VARIABLES_FIELD_DESC);
        {
          ...
          for (ScalarVariable _iter107 : struct.model_variables)
          {
      ...
      if (struct.isSetModelVariables()) {
        {
          ...
          for (ScalarVariable _iter108 : struct.model_variables)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.model_variables = new java.util.ArrayList<ScalarVariable>(_list109.size);
          @org.apache.thrift.annotation.Nullable ScalarVariable _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new ScalarVariable();
            _elem110.read(iprot);
            struct.model_variables.add(_elem110);
          }
        }
        struct.setModelVariablesIsSet(true);
      }
