...
public class BulkRead implements org.apache.thrift.TBase<BulkRead, BulkRead._Fields>, java.io.Serializable, Cloneable, Comparable<BulkRead> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.booleanValue = new java.util.ArrayList<java.lang.Boolean>(_list78.size);
                boolean _elem79;
                for (int _i80 = 0; _i80 < _list78.size; ++_i80)
                {
                  _elem79 = iprot.readBool();
                  struct.booleanValue.add(_elem79);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stringValue = new java.util.ArrayList<java.lang.String>(_list81.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem82;
                for (int _i83 = 0; _i83 < _list81.size; ++_i83)
                {
                  _elem82 = iprot.readString();
                  struct.stringValue.add(_elem82);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BulkRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.booleanValue != null) {
        oprot.writeFieldBegin(BOOLEAN_VALUE_FIELD_DESC);
        {
          ...
          for (boolean _iter86 : struct.booleanValue)
          {
            oprot.writeBool(_iter86);
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.stringValue != null) {
        oprot.writeFieldBegin(STRING_VALUE_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter87 : struct.stringValue)
          {
  ...
  private static class BulkReadTupleScheme extends org.apache.thrift.scheme.TupleScheme<BulkRead> {
      ...
      if (struct.isSetBooleanValue()) {
        {
          ...
          for (boolean _iter90 : struct.booleanValue)
          {
      ...
      if (struct.isSetStringValue()) {
        {
          ...
          for (java.lang.String _iter91 : struct.stringValue)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BulkRead struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list98 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.booleanValue = new java.util.ArrayList<java.lang.Boolean>(_list98.size);
          boolean _elem99;
          for (int _i100 = 0; _i100 < _list98.size; ++_i100)
          {
            _elem99 = iprot.readBool();
            struct.booleanValue.add(_elem99);
          }
        }
        struct.setBooleanValueIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.stringValue = new java.util.ArrayList<java.lang.String>(_list101.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = iprot.readString();
            struct.stringValue.add(_elem102);
          }
        }
        struct.setStringValueIsSet(true);
      }
