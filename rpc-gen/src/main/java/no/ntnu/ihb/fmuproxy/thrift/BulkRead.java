...
public class BulkRead implements org.apache.thrift.TBase<BulkRead, BulkRead._Fields>, java.io.Serializable, Cloneable, Comparable<BulkRead> {
  ...
  private static final org.apache.thrift.protocol.TField BOOLEAN_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("booleanValue", org.apache.thrift.protocol.TType.LIST, (short)3);
  private static final org.apache.thrift.protocol.TField STRING_VALUE_FIELD_DESC = new org.apache.thrift.protocol.TField("stringValue", org.apache.thrift.protocol.TType.LIST, (short)4);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intValue = new java.util.ArrayList<java.lang.Integer>(_list32.size);
                int _elem33;
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  _elem33 = iprot.readI32();
                  struct.intValue.add(_elem33);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.realValue = new java.util.ArrayList<java.lang.Double>(_list35.size);
                double _elem36;
                for (int _i37 = 0; _i37 < _list35.size; ++_i37)
                {
                  _elem36 = iprot.readDouble();
                  struct.realValue.add(_elem36);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.booleanValue = new java.util.ArrayList<java.lang.Boolean>(_list38.size);
                boolean _elem39;
                for (int _i40 = 0; _i40 < _list38.size; ++_i40)
                {
                  _elem39 = iprot.readBool();
                  struct.booleanValue.add(_elem39);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stringValue = new java.util.ArrayList<java.lang.String>(_list41.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem42;
                for (int _i43 = 0; _i43 < _list41.size; ++_i43)
                {
                  _elem42 = iprot.readString();
                  struct.stringValue.add(_elem42);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BulkRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.intValue != null) {
        oprot.writeFieldBegin(INT_VALUE_FIELD_DESC);
        {
          ...
          for (int _iter44 : struct.intValue)
          {
      ...
      if (struct.realValue != null) {
        oprot.writeFieldBegin(REAL_VALUE_FIELD_DESC);
        {
          ...
          for (double _iter45 : struct.realValue)
          {
      ...
      if (struct.booleanValue != null) {
        oprot.writeFieldBegin(BOOLEAN_VALUE_FIELD_DESC);
        {
          ...
          for (boolean _iter46 : struct.booleanValue)
          {
      ...
      if (struct.stringValue != null) {
        oprot.writeFieldBegin(STRING_VALUE_FIELD_DESC);
        {
          ...
          for (java.lang.String _iter47 : struct.stringValue)
          {
  ...
  private static class BulkReadTupleScheme extends org.apache.thrift.scheme.TupleScheme<BulkRead> {
      ...
      if (struct.isSetIntValue()) {
        {
          ...
          for (int _iter48 : struct.intValue)
          {
      ...
      if (struct.isSetRealValue()) {
        {
          ...
          for (double _iter49 : struct.realValue)
          {
      ...
      if (struct.isSetBooleanValue()) {
        {
          ...
          for (boolean _iter50 : struct.booleanValue)
          {
      ...
      if (struct.isSetStringValue()) {
        {
          ...
          for (java.lang.String _iter51 : struct.stringValue)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BulkRead struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.intValue = new java.util.ArrayList<java.lang.Integer>(_list52.size);
          int _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            _elem53 = iprot.readI32();
            struct.intValue.add(_elem53);
          }
        }
        struct.setIntValueIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.realValue = new java.util.ArrayList<java.lang.Double>(_list55.size);
          double _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = iprot.readDouble();
            struct.realValue.add(_elem56);
          }
        }
        struct.setRealValueIsSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list58 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.booleanValue = new java.util.ArrayList<java.lang.Boolean>(_list58.size);
          boolean _elem59;
          for (int _i60 = 0; _i60 < _list58.size; ++_i60)
          {
            _elem59 = iprot.readBool();
            struct.booleanValue.add(_elem59);
          }
        }
        struct.setBooleanValueIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.stringValue = new java.util.ArrayList<java.lang.String>(_list61.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem62;
          for (int _i63 = 0; _i63 < _list61.size; ++_i63)
          {
            _elem62 = iprot.readString();
            struct.stringValue.add(_elem62);
          }
        }
        struct.setStringValueIsSet(true);
      }
