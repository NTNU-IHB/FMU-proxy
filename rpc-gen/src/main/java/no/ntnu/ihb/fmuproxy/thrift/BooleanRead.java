            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<java.lang.Boolean>(_list24.size);
                boolean _elem25;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BooleanRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.value != null) {
        oprot.writeFieldBegin(VALUE_FIELD_DESC);
        {
          ...
          for (boolean _iter27 : struct.value)
          {
      ...
      if (struct.isSetValue()) {
        {
          ...
          for (boolean _iter28 : struct.value)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.value = new java.util.ArrayList<java.lang.Boolean>(_list29.size);
          boolean _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = iprot.readBool();
            struct.value.add(_elem30);
          }
        }
        struct.setValueIsSet(true);
      }
