...
public class ModelStructure implements org.apache.thrift.TBase<ModelStructure, ModelStructure._Fields>, java.io.Serializable, Cloneable, Comparable<ModelStructure> {
  ...
  private java.util.List<Unknown> initial_unknowns; // required
  ...
  public ModelStructure(ModelStructure other) {
    ...
    if (other.isSetInitial_unknowns()) {
  ...
  public int getInitial_unknownsSize() {
    return (this.initial_unknowns == null) ? 0 : this.initial_unknowns.size();
  }

  public java.util.Iterator<Unknown> getInitial_unknownsIterator() {
    return (this.initial_unknowns == null) ? null : this.initial_unknowns.iterator();
  }

  public void addToInitial_unknowns(Unknown elem) {
  ...
  public java.util.List<Unknown> getInitial_unknowns() {
    return this.initial_unknowns;
  }

  public ModelStructure setInitial_unknowns(java.util.List<Unknown> initial_unknowns) {
    this.initial_unknowns = initial_unknowns;
    return this;
  }

  public void unsetInitial_unknowns() {
    this.initial_unknowns = null;
  }

  /** Returns true if field initial_unknowns is set (has been assigned a value) and false otherwise */
  public boolean isSetInitial_unknowns() {
    return this.initial_unknowns != null;
  }

  public void setInitial_unknownsIsSet(boolean value) {
    if (!value) {
      this.initial_unknowns = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case INITIAL_UNKNOWNS:
      if (value == null) {
        unsetInitial_unknowns();
      } else {
        setInitial_unknowns((java.util.List<Unknown>)value);
      }
      break;
  ...
  public boolean equals(ModelStructure that) {
    ...
    boolean this_present_initial_unknowns = true && this.isSetInitial_unknowns();
    boolean that_present_initial_unknowns = true && that.isSetInitial_unknowns();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetInitial_unknowns()) ? 131071 : 524287);
    if (isSetInitial_unknowns())
  ...
  public int compareTo(ModelStructure other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetInitial_unknowns()).compareTo(other.isSetInitial_unknowns());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInitial_unknowns()) {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.outputs = new java.util.ArrayList<java.lang.Integer>(_list16.size);
                int _elem17;
          ...
          case 3: // INITIAL_UNKNOWNS
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              ...
              struct.setInitial_unknownsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelStructure struct) throws org.apache.thrift.TException {
      ...
      if (struct.outputs != null) {
        oprot.writeFieldBegin(OUTPUTS_FIELD_DESC);
        {
          ...
          for (int _iter25 : struct.outputs)
          {
  ...
  private static class ModelStructureTupleScheme extends org.apache.thrift.scheme.TupleScheme<ModelStructure> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ModelStructure struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetInitial_unknowns()) {
        optionals.set(2);
      }
      ...
      if (struct.isSetOutputs()) {
        {
          ...
          for (int _iter28 : struct.outputs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.outputs = new java.util.ArrayList<java.lang.Integer>(_list31.size);
          int _elem32;
