            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.initialUnknowns = new java.util.ArrayList<Unknown>(_list22.size);
                @org.apache.thrift.annotation.Nullable Unknown _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = new Unknown();
                  _elem23.read(iprot);
                  struct.initialUnknowns.add(_elem23);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelStructure struct) throws org.apache.thrift.TException {
      ...
      if (struct.initialUnknowns != null) {
        oprot.writeFieldBegin(INITIAL_UNKNOWNS_FIELD_DESC);
        {
          ...
          for (Unknown _iter27 : struct.initialUnknowns)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetInitialUnknowns()) {
        {
          ...
          for (Unknown _iter30 : struct.initialUnknowns)
          {
            _iter30.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.initialUnknowns = new java.util.ArrayList<Unknown>(_list37.size);
          @org.apache.thrift.annotation.Nullable Unknown _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new Unknown();
            _elem38.read(iprot);
            struct.initialUnknowns.add(_elem38);
          }
        }
        struct.setInitialUnknownsIsSet(true);
      }
