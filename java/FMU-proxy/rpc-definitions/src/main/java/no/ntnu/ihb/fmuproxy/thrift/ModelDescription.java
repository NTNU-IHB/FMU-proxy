            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.modelVariables = new java.util.ArrayList<ScalarVariable>(_list72.size);
                @org.apache.thrift.annotation.Nullable ScalarVariable _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new ScalarVariable();
                  _elem73.read(iprot);
                  struct.modelVariables.add(_elem73);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelDescription struct) throws org.apache.thrift.TException {
      ...
      if (struct.modelVariables != null) {
        oprot.writeFieldBegin(MODEL_VARIABLES_FIELD_DESC);
        {
          ...
          for (ScalarVariable _iter75 : struct.modelVariables)
          {
            _iter75.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetModelVariables()) {
        {
          ...
          for (ScalarVariable _iter76 : struct.modelVariables)
          {
            _iter76.write(oprot);
          }
        }
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.modelVariables = new java.util.ArrayList<ScalarVariable>(_list77.size);
          @org.apache.thrift.annotation.Nullable ScalarVariable _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new ScalarVariable();
            _elem78.read(iprot);
            struct.modelVariables.add(_elem78);
          }
        }
        struct.setModelVariablesIsSet(true);
      }
