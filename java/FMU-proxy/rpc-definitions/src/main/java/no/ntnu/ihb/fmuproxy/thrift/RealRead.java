...
public class RealRead implements org.apache.thrift.TBase<RealRead, RealRead._Fields>, java.io.Serializable, Cloneable, Comparable<RealRead> {
  ...
  public java.util.List<java.lang.Double> value; // required
  /**
   * 
   * @see Status
   */
  ...
  public RealRead setValue(java.util.List<java.lang.Double> value) {
    this.value = value;
    return this;
  }
   ...
   * @see Status
   */
  public RealRead setStatus(Status status) {
    this.status = status;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<java.lang.Double>(_list40.size);
                double _elem41;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RealRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.value != null) {
        oprot.writeFieldBegin(VALUE_FIELD_DESC);
        {
          ...
          for (double _iter43 : struct.value)
          {
      ...
      if (struct.isSetValue()) {
        {
          ...
          for (double _iter44 : struct.value)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.value = new java.util.ArrayList<java.lang.Double>(_list45.size);
          double _elem46;
