...
public class BooleanRead implements org.apache.thrift.TBase<BooleanRead, BooleanRead._Fields>, java.io.Serializable, Cloneable, Comparable<BooleanRead> {
  ...
  public java.util.List<java.lang.Boolean> value; // required
  /**
   * 
   * @see Status
   */
  ...
  public BooleanRead setValue(java.util.List<java.lang.Boolean> value) {
    this.value = value;
    return this;
  }
   ...
   * @see Status
   */
  public BooleanRead setStatus(Status status) {
    this.status = status;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.value = new java.util.ArrayList<java.lang.Boolean>(_list56.size);
                boolean _elem57;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BooleanRead struct) throws org.apache.thrift.TException {
      ...
      if (struct.value != null) {
        oprot.writeFieldBegin(VALUE_FIELD_DESC);
        {
          ...
          for (boolean _iter59 : struct.value)
          {
      ...
      if (struct.isSetValue()) {
        {
          ...
          for (boolean _iter60 : struct.value)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.value = new java.util.ArrayList<java.lang.Boolean>(_list61.size);
          boolean _elem62;
